...
export class Init1754648057399 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "plugin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "version" character varying, "description" character varying, "depends_on" jsonb, "config" jsonb, CONSTRAINT "PK_9a65387180b2e67287345684c03" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_d48c4e23bf4cc989ccc9598b39" ON "licenses" ("licenseId") `);
        await queryRunner.query(`CREATE TABLE "epss" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cve" character varying NOT NULL, "score" double precision, "percentile" double precision, CONSTRAINT "PK_3849ad9c24a83f52032bdd766d6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_9cc3075a662b00d9b3b6d1590f" ON "epss" ("cve") `);
        await queryRunner.query(`ALTER TABLE "result" ADD "created_on" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`CREATE TYPE "public"."analysis_schedule_type_enum" AS ENUM('once', 'daily', 'weekly')`);
        await queryRunner.query(`ALTER TABLE "analysis" ADD "schedule_type" "public"."analysis_schedule_type_enum" DEFAULT 'once'`);
        await queryRunner.query(`ALTER TABLE "analysis" ADD "next_scheduled_run" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "analysis" ADD "is_active" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "analysis" ADD "last_scheduled_run" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "js_version" ADD CONSTRAINT "FK_db3d7c4b2252809ded17121804e" FOREIGN KEY ("packageId") REFERENCES "package"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "js_version" DROP CONSTRAINT "FK_db3d7c4b2252809ded17121804e"`);
