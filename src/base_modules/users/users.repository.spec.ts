...
describe("UsersRepository", () => {
  ...
  describe("getUserById", () => {
    ...
    it("should throw EntityNotFound when user does not exist", async () => {
      ...
      // Act & Assert
      await expect(
        usersRepository.getUserById("non-existent-id"),
    ...
    it("should handle database errors", async () => {
      ...
      // Act & Assert
      await expect(usersRepository.getUserById("user-123")).rejects.toThrow(
        dbError,
      );
    });
  });
  ...
  describe("getUserByEmail", () => {
    ...
    it("should throw UserDoesNotExist when user not found", async () => {
      ...
      // Act & Assert
      await expect(
        usersRepository.getUserByEmail("unknown@example.com"),
  ...
  describe("saveUser", () => {
    ...
    it("should handle save errors", async () => {
      ...
      // Act & Assert
      await expect(usersRepository.saveUser(mockUser)).rejects.toThrow(
        saveError,
      );
    });
  ...
  describe("deleteUser", () => {
    it("should delete user and related data", async () => {
      // Arrange
      mockOrganizationsRepository.removeUserMemberships.mockResolvedValue(
        undefined,
      );
      ...
      // Assert
      expect(
        mockOrganizationsRepository.removeUserMemberships,
      ).toHaveBeenCalledWith("user-123");
      expect(mockProjectsRepository.deleteUserProjects).toHaveBeenCalledWith(
        "user-123",
      );
    ...
    it("should handle errors in membership removal", async () => {
      ...
      mockOrganizationsRepository.removeUserMemberships.mockRejectedValue(
        error,
      );

      // Act & Assert
      await expect(usersRepository.deleteUser("user-123")).rejects.toThrow(
        error,
      );
  ...
  describe("edge cases", () => {
    it("should handle empty string user ID", async () => {
      ...
      // Act & Assert
      await expect(usersRepository.getUserById("")).rejects.toThrow(
        EntityNotFound,
      );
    });
    ...
    it("should handle empty string email", async () => {
      ...
      // Act & Assert
      await expect(usersRepository.getUserByEmail("")).rejects.toThrow(
        UserDoesNotExist,
      );
    });
