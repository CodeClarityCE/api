...
describe("ProjectsRepository", () => {
  ...
  describe("getProjectById", () => {
    ...
    it("should return project with relations when specified", async () => {
      ...
      // Act
      const result = await projectsRepository.getProjectById(
        "project-123",
        relations,
      );
    ...
    it("should throw EntityNotFound when project does not exist", async () => {
      ...
      // Act & Assert
      await expect(
        projectsRepository.getProjectById("non-existent"),
  ...
  describe("getProjectByIdAndOrganization", () => {
    ...
    it("should throw ProjectDoesNotExist when project not found in organization", async () => {
      ...
      // Act & Assert
      await expect(
        projectsRepository.getProjectByIdAndOrganization(
          "project-123",
          "wrong-org",
        ),
  ...
  describe("deleteProject", () => {
    ...
    it("should handle delete errors", async () => {
      ...
      // Act & Assert
      await expect(
        projectsRepository.deleteProject("project-123"),
  ...
  describe("saveProject", () => {
    ...
    it("should handle save errors", async () => {
      ...
      // Act & Assert
      await expect(projectsRepository.saveProject(mockProject)).rejects.toThrow(
        error,
      );
    });
  });
  ...
  describe("getManyProjects", () => {
    ...
    it("should apply search filter when searchKey provided", async () => {
      ...
      // Act
      const result = await projectsRepository.getManyProjects(
        "org-123",
        0,
        10,
        "test",
