...
describe('RefreshJwtAuthGuard', () => {
    ...
    describe('handleRequest', () => {
        ...
        it('should handle specific refresh token errors', () => {
            ...
            expect(() => guard.handleRequest(refreshTokenError, null)).toThrow(refreshTokenError);
            expect(() => guard.handleRequest(malformedTokenError, null)).toThrow(
                malformedTokenError
            );
            expect(() => guard.handleRequest(invalidTokenError, null)).toThrow(invalidTokenError);
        });
