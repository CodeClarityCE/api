...
describe('GitlabIntegration Types', () => {
    describe('GitlabTokenType', () => {
        it('should have correct enum values', () => {
            ...
            expect(GitlabTokenType.PERSONAL_ACCESS_TOKEN).toBe('PERSONAL_ACCESS_TOKEN');
        });
    });
    ...
    describe('GitlabIntegration', () => {
        it('should create a valid GitlabIntegration instance', () => {
            ...
            expect(gitlabIntegration.token_type).toBe(GitlabTokenType.PERSONAL_ACCESS_TOKEN);
    ...
    describe('GitLabIntegrationCreate', () => {
        it('should create a valid GitLabIntegrationCreate instance', () => {
            ...
            expect(gitlabIntegrationCreate.integration_type).toBe(IntegrationType.VCS);
            expect(gitlabIntegrationCreate.integration_provider).toBe(IntegrationProvider.GITLAB);
            expect(gitlabIntegrationCreate.token_type).toBe(GitlabTokenType.PERSONAL_ACCESS_TOKEN);
            expect(gitlabIntegrationCreate.service_base_url).toBe('https://gitlab.com');
    ...
    describe('GitLabIntegrationUpdate', () => {
        it('should create a valid GitLabIntegrationUpdate instance', () => {
            ...
            gitlabIntegrationUpdate.token_type = GitlabTokenType.PERSONAL_ACCESS_TOKEN;
            ...
            expect(gitlabIntegrationUpdate.token_type).toBe(GitlabTokenType.PERSONAL_ACCESS_TOKEN);
            expect(gitlabIntegrationUpdate.service_base_url).toBe('https://gitlab.com');
