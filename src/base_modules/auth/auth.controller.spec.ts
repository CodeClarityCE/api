...
describe("AuthController", () => {
  ...
  describe("getAuthenticatedAccount", () => {
    it("should return authenticated user", async () => {
      ...
      const result = await controller.getAuthenticatedAccount(
  ...
  describe("confirmRegistration", () => {
    ...
    it("should throw error for invalid token", async () => {
      ...
      await expect(
        controller.confirmRegistration(confirmationBody),
  ...
  describe("passwordReset", () => {
    ...
    it("should throw error for invalid token", async () => {
      ...
      usersService.resetPassword.mockRejectedValue(
        new PasswordResetTokenInvalidOrExpired(),
      );
