...
describe('AnalysesRepository', () => {
    ...
    beforeEach(async () => {
        ...
        mockAnalysisRepository = module.get(getRepositoryToken(Analysis, 'codeclarity'));
    });
    ...
    describe('saveAnalysis', () => {
        ...
        it('should handle save errors', async () => {
            ...
            await expect(analysesRepository.saveAnalysis(mockAnalysis)).rejects.toThrow(saveError);
            expect(mockAnalysisRepository.save).toHaveBeenCalledWith(mockAnalysis);
        });
    ...
    describe('deleteAnalysis', () => {
        it('should delete analysis by id', async () => {
            ...
            expect(mockAnalysisRepository.delete).toHaveBeenCalledWith('analysis-123');
        });
        ...
        it('should handle delete errors', async () => {
            ...
            await expect(analysesRepository.deleteAnalysis('analysis-123')).rejects.toThrow(
                deleteError
            );
            expect(mockAnalysisRepository.delete).toHaveBeenCalledWith('analysis-123');
        });
        ...
        it('should handle deleting non-existent analysis', async () => {
            ...
            expect(mockAnalysisRepository.delete).toHaveBeenCalledWith('non-existent-id');
        });
    });
    ...
    describe('removeAnalyses', () => {
        ...
        it('should handle remove errors', async () => {
            ...
            await expect(analysesRepository.removeAnalyses(analyses)).rejects.toThrow(removeError);
            expect(mockAnalysisRepository.remove).toHaveBeenCalledWith(analyses);
        });
    ...
    describe('getAnalysisById', () => {
        ...
        it('should return analysis with relations when specified', async () => {
            ...
            const result = await analysesRepository.getAnalysisById('analysis-123', relations);
        ...
        it('should throw EntityNotFound when analysis does not exist', async () => {
            ...
            await expect(analysesRepository.getAnalysisById('non-existent-id')).rejects.toThrow(
                EntityNotFound
            );
            expect(mockAnalysisRepository.findOne).toHaveBeenCalledWith({
        ...
        it('should handle database errors', async () => {
            ...
            await expect(analysesRepository.getAnalysisById('analysis-123')).rejects.toThrow(
                dbError
            );
        });
        ...
        it('should handle null relations parameter', async () => {
            ...
            const result = await analysesRepository.getAnalysisById('analysis-123', null as any);
    ...
    describe('getAnalysisByProjectId', () => {
        it('should return paginated analyses for a project', async () => {
            const mockAnalyses = [mockAnalysis, { ...mockAnalysis, id: 'analysis-456' }];
            mockQueryBuilder.getCount.mockResolvedValue(5);
            mockQueryBuilder.getMany.mockResolvedValue(mockAnalyses);

            const result = await analysesRepository.getAnalysisByProjectId('project-123', 0, 10);
            ...
            expect(mockAnalysisRepository.createQueryBuilder).toHaveBeenCalledWith('analysis');
            expect(mockQueryBuilder.orderBy).toHaveBeenCalledWith('analysis.created_on', 'DESC');
            expect(mockQueryBuilder.where).toHaveBeenCalledWith('analysis.projectId = :projectId', {
        ...
        it('should handle pagination correctly for second page', async () => {
            ...
            const result = await analysesRepository.getAnalysisByProjectId('project-123', 2, 10);
    ...
    describe('getAnalysesByProjectId', () => {
        it('should return all analyses for a project', async () => {
            ...
            const result = await analysesRepository.getAnalysesByProjectId('project-123');
        ...
        it('should handle database errors', async () => {
            ...
            await expect(analysesRepository.getAnalysesByProjectId('project-123')).rejects.toThrow(
                dbError
            );
        });
    });
    ...
    describe('doesAnalysesBelongToProject', () => {
        it('should not throw when analysis belongs to project', async () => {
            ...
            await expect(
                analysesRepository.doesAnalysesBelongToProject('analysis-123', 'project-123')
        ...
        it('should throw NotAuthorized when analysis does not belong to project', async () => {
            ...
            await expect(
                analysesRepository.doesAnalysesBelongToProject('analysis-123', 'wrong-project-id')
        ...
        it('should throw NotAuthorized when analysis does not exist', async () => {
            ...
            await expect(
                analysesRepository.doesAnalysesBelongToProject('non-existent-id', 'project-123')
            ).rejects.toThrow(NotAuthorized);
        });
        ...
        it('should handle empty string IDs', async () => {
            ...
            await expect(analysesRepository.doesAnalysesBelongToProject('', '')).rejects.toThrow(
                NotAuthorized
            );
    ...
    describe('edge cases and error handling', () => {
        ...
        it('should handle large pagination values', async () => {
            ...
            await analysesRepository.getAnalysisByProjectId('project-123', 999999, 1000);
