...
export class AnalysisCreateBody {
  ...
  @ApiProperty({
    description: "Which branch of the repository to analyze",
    example: "main",
  })
  @IsNotEmpty()
  branch!: string;
  ...
  @ApiProperty({
    description: "Which tag of the repository to analyze",
    example: "v1.0.0",
  })
  @IsOptional()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description:
      "Programming language(s) to analyze. If not specified, will be auto-detected.",
  ...
  @ApiProperty({
    ...
    examples: {
      ...
      weekly: {
        value: "weekly",
        description: "Run every week at specified time",
      },
    },
  })
  @IsOptional()
...
export class ScheduleUpdateBody {
  @ApiProperty({
    ...
    examples: {
      immediate: {
        value: "once",
        description: "Convert to one-time execution",
      },
