...
describe('VersionsRepository', () => {
    ...
    describe('getVersion', () => {
        ...
        it('should throw EntityNotFound when package does not exist', async () => {
            ...
            await expect(repository.getVersion('non-existent-package', '1.0.0')).rejects.toThrow(
                EntityNotFound
            );
        ...
        it('should throw EntityNotFound when version does not exist', async () => {
            ...
            await expect(repository.getVersion('test-package', '9.9.9')).rejects.toThrow(
                EntityNotFound
            );
        ...
        it('should handle database errors', async () => {
            ...
            await expect(repository.getVersion('test-package', '1.0.0')).rejects.toThrow(
    ...
    describe('getDependencyVersions', () => {
        ...
        it('should throw EntityNotFound when package does not exist', async () => {
            ...
            await expect(repository.getDependencyVersions('non-existent-package')).rejects.toThrow(
                EntityNotFound
            );
        ...
        it('should handle complex semver sorting', async () => {
            ...
            mockPackageRepository.findOne.mockResolvedValue(packageWithComplexVersions);
        ...
        it('should handle database errors', async () => {
            ...
            await expect(repository.getDependencyVersions('test-package')).rejects.toThrow(
                'Database connection failed'
            );
        });
    });
