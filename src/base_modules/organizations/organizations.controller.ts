...
export class OrganizationsController {
  ...
  async getMetaData(
    ...
    return {
      data: await this.organizationsService.getOrgMetaData(
        organization_id,
        user,
      ),
    };
  ...
  @ApiErrorDecorator({
    statusCode: 400,
    errors: [PersonalOrgCannotBeModified, EntityNotFound],
  })
  @ApiErrorDecorator({ statusCode: 500, errors: [InternalError] })
  ...
  async updateSettings(
    ...
    await this.organizationsService.updateSettings(
      organization_id,
      settingsBody,
      user,
    );
  ...
  async getOrgMember(
    ...
    return {
      data: await this.organizationsService.getOrgMember(
        user_id,
        organization_id,
        user,
      ),
  ...
  async revokeMembership(
    ...
    await this.organizationsService.revokeOrgMemberShip(
      organization_id,
      user_id,
      user,
    );
  ...
  async joinOrg(
    ...
    await this.organizationsService.joinOrg(
      joinOrgBody.token,
      joinOrgBody.email_digest,
      user,
    );
    return {};
  }
  ...
  async inviteeInfo(
    ...
    const info = await this.organizationsService.getInviteeInfo(
      token,
      user_email_hash,
      user,
    );
