...
describe("PluginsRepository", () => {
  ...
  describe("getById", () => {
    ...
    it("should throw an error when plugin is not found", async () => {
      ...
      await expect(
        pluginsRepository.getById("non-existent-id"),
    ...
    it("should handle empty string id", async () => {
      ...
      await expect(pluginsRepository.getById("")).rejects.toThrow(
        "No plugins found",
      );
    ...
    it("should handle very long id strings", async () => {
      ...
      await expect(pluginsRepository.getById(longId)).rejects.toThrow(
        "No plugins found",
      );
  ...
  describe("getAll", () => {
    ...
    it("should throw an error when find returns null", async () => {
      ...
      await expect(pluginsRepository.getAll()).rejects.toThrow(
        "No plugins found",
      );
