...
describe("ApiKeysController", () => {
  ...
  describe("createApiKey", () => {
    it('should throw "Not implemented" error', async () => {
      await expect(controller.createApiKey()).rejects.toThrow(
        "Not implemented",
      );
    });
  });
  ...
  describe("getApiKeyUsageLogs", () => {
    it('should throw "Not implemented" error', async () => {
      await expect(controller.getApiKeyUsageLogs()).rejects.toThrow(
        "Not implemented",
      );
    });
  });
  ...
  describe("deleteApiKey", () => {
    ...
    it("should propagate service errors", async () => {
      ...
      await expect(
        controller.deleteApiKey(mockAuthenticatedUser, apiKeyId),
