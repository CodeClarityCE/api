...
describe("OrganizationsController", () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        { provide: OrganizationsService, useValue: mockOrganizationsService },
        {
          ...
          useValue: mockOrganizationLoggerService,
        },
  ...
  describe("create", () => {
    ...
    it("should throw NotAuthenticated when user is not authenticated", async () => {
      ...
      await expect(
        controller.create(mockAuthenticatedUser, createBody),
  ...
  describe("get", () => {
    ...
    it("should throw EntityNotFound when organization does not exist", async () => {
      ...
      await expect(
        controller.get(mockAuthenticatedUser, "nonexistent-org"),
    ...
    it("should throw NotAuthorized when user lacks permission", async () => {
      ...
      await expect(
        controller.get(mockAuthenticatedUser, "other-org-id"),
  ...
  describe("getMetaData", () => {
    ...
    it("should throw EntityNotFound when organization does not exist", async () => {
      organizationsService.getOrgMetaData.mockRejectedValue(
        new EntityNotFound(),
      );
  ...
  describe("leaveOrg", () => {
    it("should leave organization successfully", async () => {
      ...
      const result = await controller.leaveOrg(
        mockAuthenticatedUser,
        "test-org-id",
      );
    ...
    it("should throw CannotLeaveAsOwner when user is the owner", async () => {
      ...
      await expect(
        controller.leaveOrg(mockAuthenticatedUser, "test-org-id"),
      ).rejects.toThrow(CannotLeaveAsOwner);
    });

    it("should throw PersonalOrgCannotBeModified for personal organization", async () => {
      organizationsService.leaveOrg.mockRejectedValue(
        new PersonalOrgCannotBeModified(),
      );
  ...
  describe("deleteOrg", () => {
    it("should delete organization successfully", async () => {
      ...
      const result = await controller.deleteOrg(
        mockAuthenticatedUser,
        "test-org-id",
      );
    ...
    it("should throw PersonalOrgCannotBeModified for personal organization", async () => {
      organizationsService.deleteOrg.mockRejectedValue(
        new PersonalOrgCannotBeModified(),
      );
