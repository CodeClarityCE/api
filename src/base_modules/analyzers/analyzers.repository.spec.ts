...
describe("AnalyzersRepository", () => {
  ...
  beforeEach(async () => {
    ...
    mockAnalyzerRepository = module.get(
      getRepositoryToken(Analyzer, "codeclarity"),
    );
  });
  ...
  describe("getAnalyzerById", () => {
    ...
    it("should throw AnalyzerDoesNotExist when analyzer not found", async () => {
      ...
      await expect(
        analyzersRepository.getAnalyzerById("non-existent"),
  ...
  describe("saveAnalyzer", () => {
    ...
    it("should handle save errors", async () => {
      ...
      await expect(
        analyzersRepository.saveAnalyzer(mockAnalyzer),
  ...
  describe("deleteAnalyzer", () => {
    it("should delete analyzer successfully", async () => {
      ...
      expect(mockAnalyzerRepository.delete).toHaveBeenCalledWith(
        "analyzer-123",
      );
    });
    ...
    it("should handle delete errors", async () => {
      ...
      await expect(
        analyzersRepository.deleteAnalyzer("analyzer-123"),
      ).rejects.toThrow(error);
    });
  });
  ...
  describe("doesAnalyzerBelongToOrg", () => {
    it("should return without error for global analyzer", async () => {
      ...
      await expect(
        analyzersRepository.doesAnalyzerBelongToOrg(
          "global-analyzer-123",
          "org-123",
        ),
  ...
  describe("getByNameAndOrganization", () => {
    ...
    beforeEach(() => {
      mockAnalyzerRepository.createQueryBuilder.mockReturnValue(
  ...
  describe("getManyAnalyzers", () => {
    ...
    it("should return paginated analyzers for organization", async () => {
      ...
      const result = await analyzersRepository.getManyAnalyzers(
        "org-123",
        0,
        5,
      );
