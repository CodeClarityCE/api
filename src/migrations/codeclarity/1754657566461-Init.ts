...
export class Init1754657566461 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "notification_users_user" ADD CONSTRAINT "FK_9c0c1c8c13cf53180e087e7f364" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
