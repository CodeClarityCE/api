...
describe("DependencyPatchPolicyService", () => {
  ...
  const mockCreateBody: DependencyPatchPolicyCreateBody = {
    ...
    full_fix_version_selection_preference:
      FullFixVersionSelection.SELECT_NEWEST,
  ...
  beforeEach(async () => {
    ...
    service = module.get<DependencyPatchPolicyService>(
  ...
  describe("create", () => {
    it("should throw not implemented error", async () => {
      await expect(
        service.create("org-123", mockCreateBody, mockUser),
