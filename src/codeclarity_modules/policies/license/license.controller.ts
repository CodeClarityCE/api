...
import {
  Policy,
  PolicyFrontend,
} from "src/codeclarity_modules/policies/policy.entity";
...
export class LicensePolicyController {
  ...
  async create(
    ...
    return {
      id: await this.licensePolicyService.create(org_id, createBody, user),
    };
  }
  ...
  async get(
    ...
    return {
      data: await this.licensePolicyService.get(org_id, policy_id, user),
    };
  }
  ...
  async update(
    ...
    await this.licensePolicyService.update(
      org_id,
      policy_id,
      licensePolicyPatchBody,
      user,
