...
export class AddLanguageSupportToAnalyzer1755420544883 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "analyzer" ADD "language_config" jsonb`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_39ff8ef2cc3c9049db3deec202"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_921eb527e0524bedec502f33df"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "analyzer" DROP COLUMN "language_config"`,
    );
    await queryRunner.query(
      `ALTER TABLE "analyzer" DROP COLUMN "supported_languages"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bf51b0714db5797935da2e64a1"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_11b2b7911ddb3ef266b1dafadc"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_efaf48ac3246f46e661a338640"`,
    );
