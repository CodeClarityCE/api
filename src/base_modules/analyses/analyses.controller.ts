...
export class AnalysesController {
  ...
  async create(
    ...
    return {
      id: await this.analysesService.create(org_id, project_id, analysis, user),
    };
  }
  ...
  async get(
    ...
    return {
      data: await this.analysesService.get(
        org_id,
        project_id,
        analysis_id,
        user,
  ...
  async getChart(
    ...
    return {
      data: await this.analysesService.getChart(
        org_id,
        project_id,
        analysis_id,
        user,
  ...
  async getScheduled(
    ...
    const analyses = await this.analysesService.getScheduledAnalyses(
      org_id,
      project_id,
      user,
    );
  ...
  @ApiOperation({
    ...
    summary:
      "Modify scheduling configuration (frequency, timing, active status)",
  })
  @APIDocNoDataResponseDecorator()
  @ApiErrorDecorator({ statusCode: 403, errors: [NotAuthorized] })
  @ApiErrorDecorator({ statusCode: 404, errors: [EntityNotFound] })
  ...
  async cancelSchedule(
    ...
    await this.analysesService.cancelSchedule(
      org_id,
      project_id,
      analysis_id,
      user,
  ...
  @ApiOperation({
    ...
    summary:
      "Duplicate scheduled analysis for new execution - preserves historical results",
  })
  @APIDocCreatedResponseDecorator()
  @ApiErrorDecorator({ statusCode: 403, errors: [NotAuthorized] })
  @ApiErrorDecorator({ statusCode: 404, errors: [EntityNotFound] })
  ...
  async createScheduledExecution(
    ...
    const newAnalysisId =
      await this.analysesService.createScheduledExecution(analysis_id);
