...
import { type Ticket, TicketPriority, type TicketStatus } from '../ticket.entity';
...
export interface ITicketIntegrationProvider {
     ...
     */
    createExternalTicket(ticket: Ticket, config: IntegrationConfig): Promise<ExternalTicketResult>;
     ...
     * @param config The integration configuration
     */
    getSpaces?(workspaceId: string, config: IntegrationConfig): Promise<ExternalSpace[]>;
     ...
     * @param config The integration configuration
     */
    getFolders?(spaceId: string, config: IntegrationConfig): Promise<ExternalFolder[]>;
