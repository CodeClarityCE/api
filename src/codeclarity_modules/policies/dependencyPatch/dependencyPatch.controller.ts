...
export class DependencyPatchPolicyController {
  constructor(
    private readonly dependencyPatchPolicyService: DependencyPatchPolicyService,
  ) {}
  ...
  async create(
    ...
    return {
      id: await this.dependencyPatchPolicyService.create(
        org_id,
        createBody,
        user,
      ),
  ...
  async get(
    ...
    return {
      data: await this.dependencyPatchPolicyService.get(
        org_id,
        policy_id,
        user,
      ),
