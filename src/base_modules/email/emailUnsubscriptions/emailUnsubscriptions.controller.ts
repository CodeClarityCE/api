...
export class EmailUnsubscriptionController {
  constructor(
    private readonly emailUnsubscribeService: EmailUnsubscriptionService,
  ) {}

  @NonAuthEndpoint()
  @Post("")
  async unsubscribeViaEmailLink(
    @Body() body: EmailUnsubscribePostBody,
  ): Promise<NoDataResponse> {
    await this.emailUnsubscribeService.unsubscribeViaEmailLink(
      body.token,
      body.email_digest,
    );
    return {};
