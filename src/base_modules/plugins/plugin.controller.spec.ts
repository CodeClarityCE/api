...
describe("PluginController", () => {
  ...
  describe("get", () => {
    ...
    it("should handle service errors", async () => {
      ...
      await expect(
        pluginController.get(mockUser, "non-existent-id"),
    ...
    it("should work with different user contexts", async () => {
      const differentUser = new AuthenticatedUser(
        "other-user-789",
        [ROLE.USER],
        true,
      );
  ...
  describe("getAll", () => {
    ...
    it("should handle service errors", async () => {
      ...
      await expect(pluginController.getAll(mockUser)).rejects.toThrow(
        "Database error",
      );
  ...
  describe("Error Scenarios", () => {
    ...
    it("should propagate unexpected errors from service", async () => {
      pluginService.getAll.mockRejectedValue(
