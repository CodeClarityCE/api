...
describe("AnalysisResultsRepository", () => {
  ...
  beforeEach(async () => {
    ...
    repository = module.get<AnalysisResultsRepository>(
      AnalysisResultsRepository,
    );
  ...
  describe("delete", () => {
    ...
    it("should handle deletion of non-existent result", async () => {
      ...
      expect(resultRepository.delete).toHaveBeenCalledWith(
        "non-existent-result",
      );
    });
  ...
  describe("getByAnalysisId", () => {
    ...
    it("should return result with relations when provided", async () => {
      ...
      const result = await repository.getByAnalysisId(
        "analysis-123",
        relations,
      );
    ...
    it("should throw EntityNotFound when analysis does not exist", async () => {
      ...
      await expect(
        repository.getByAnalysisId("non-existent-analysis"),
  ...
  describe("resultOfAnalysisReady", () => {
    ...
    it("should return false when no result exists for analysis", async () => {
      ...
      const result = await repository.resultOfAnalysisReady(
    ...
    it("should handle database errors", async () => {
      ...
      await expect(
        repository.resultOfAnalysisReady("analysis-123"),
      ).rejects.toThrow("Database connection failed");
    });
