  ...
  describe("OSVReportGenerator", () => {
    describe("genReport", () => {
      it("should generate a report from OSV data", async () => {
        ...
        expect(result.vulnerability_info.vulnerability_id).toBe(
          "CVE-2024-1234",
        );
        ...
        expect(
          result.vulnerability_info.version_info.affected_versions_string,
        ).toBe(">= 1.0.0 < 1.0.1");
      ...
      it("should handle OSV without CVE", async () => {
        ...
        expect(result.vulnerability_info.aliases).toContain(
          "GHSA-1234-5678-9012",
        );
        expect(result.vulnerability_info.aliases).not.toContain(
          "CVE-2024-1234",
        );
      });
