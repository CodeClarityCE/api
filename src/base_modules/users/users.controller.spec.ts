...
describe('UsersController', () => {
    ...
    describe('get', () => {
        it('should return user data', async () => {
            ...
            const result = await controller.get(mockAuthenticatedUser, 'test-user-id');
        ...
        it('should throw EntityNotFound when user does not exist', async () => {
            ...
            await expect(controller.get(mockAuthenticatedUser, 'nonexistent-id')).rejects.toThrow(
                EntityNotFound
            );
        });
        ...
        it('should throw NotAuthorized when user lacks permission', async () => {
            ...
            await expect(controller.get(mockAuthenticatedUser, 'other-user-id')).rejects.toThrow(
                NotAuthorized
            );
        });
    });
    ...
    describe('reSendAccountRegVerificationEmail', () => {
        it('should resend verification email successfully', async () => {
            ...
            usersService.sendUserRegistrationVerificationEmail.mockResolvedValue(undefined);
        ...
        it('should throw error when email sending fails', async () => {
            ...
            await expect(controller.reSendAccountRegVerificationEmail(body)).rejects.toThrow(
                FailedToSendAccountRegistrationVerificationEmail
            );
        });
    });
    ...
    describe('completeSocialAccountSetup', () => {
        it('should complete social account setup successfully', async () => {
            ...
            usersService.completeSocialAccountSetup.mockResolvedValue('completed-user-id');
        ...
        it('should throw error when setup already done', async () => {
            ...
            usersService.completeSocialAccountSetup.mockRejectedValue(new SetupAlreadyDone());
    ...
    describe('updateAccountPassword', () => {
        ...
        it('should throw error for social account', async () => {
            ...
            usersService.updatePassword.mockRejectedValue(new CannotPerformActionOnSocialAccount());

            await expect(
                controller.updateAccountPassword(mockAuthenticatedUser, patch, 'test-user-id')
    ...
    describe('updateAccountInfo', () => {
        ...
        it('should throw NotAuthorized when user lacks permission', async () => {
            ...
            await expect(
                controller.updateAccountInfo(mockAuthenticatedUser, patch, 'other-user-id')
            ).rejects.toThrow(NotAuthorized);
        });
    });
    ...
    describe('updateDefaultOrg', () => {
        ...
        it('should throw EntityNotFound when organization does not exist', async () => {
            ...
            await expect(
                controller.updateDefaultOrg(mockAuthenticatedUser, patch, 'test-user-id')
