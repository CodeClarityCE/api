...
export class Init1754648057399 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "analysis" DROP COLUMN "last_scheduled_run"`,
    );
    await queryRunner.query(`ALTER TABLE "analysis" DROP COLUMN "is_active"`);
    await queryRunner.query(
      `ALTER TABLE "analysis" DROP COLUMN "next_scheduled_run"`,
    );
    await queryRunner.query(
      `ALTER TABLE "analysis" DROP COLUMN "schedule_type"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9cc3075a662b00d9b3b6d1590f"`,
    );
    await queryRunner.query(`DROP TABLE "epss"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d48c4e23bf4cc989ccc9598b39"`,
    );
    await queryRunner.query(`DROP INDEX "public"."idx_license_name"`);
    await queryRunner.query(`DROP TABLE "licenses"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_129e04e01810e12ea16e48b275"`,
    );
    await queryRunner.query(`DROP TABLE "cwe"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ff27e0c5a71cd3d2b6623d4631"`,
    );
    await queryRunner.query(`DROP TABLE "nvd"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a1a455434143cac56134910e0b"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b23e12326a4218d09bd72301aa"`,
    );
