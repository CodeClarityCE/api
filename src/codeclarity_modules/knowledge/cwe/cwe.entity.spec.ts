    ...
    it("should handle CWE-89 (SQL Injection) data structure", () => {
      ...
      cwe.observed_examples = [
        ...
        },
        {
          ...
          description:
            "SQL injection in library intended for database authentication.",
      ...
      expect(
        (cwe.observed_examples as { reference: string }[])[0]!.reference,
      ).toBe("CVE-2008-2790");
    });
