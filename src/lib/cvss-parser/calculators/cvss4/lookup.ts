/**
 * CVSS v4.0 MacroVector Lookup Tables
 * Source: https://github.com/FIRSTdotorg/cvss-v4-calculator
 * License: BSD-2-Clause
 */

/**
 * MacroVector to CVSS score lookup table
 * Keys are 6-digit strings representing EQ1-EQ5 (with EQ3+EQ6 combined)
 */
export const cvssLookup: Record<string, number> = {
  "000000": 10,
  "000001": 9.9,
  "000010": 9.8,
  "000011": 9.5,
...
/**
 * Maximum severity distances for each equivalence class level
 */
...
/**
 * Maximum composed vectors for each EQ level
 * Used to find the highest severity vector within an equivalence class
 */
...
/**
 * Severity distance values for each metric
 * Lower values indicate higher severity
 */
export const severityDistance: Record<string, Record<string, number>> = {
