...
describe("FileRepository", () => {
  ...
  describe("remove", () => {
    ...
    it("should throw error if remove fails", async () => {
      ...
      await expect(fileRepository.remove(mockFile)).rejects.toThrow(
        "Database error",
      );
    });
  });
  ...
  describe("deleteFiles", () => {
    ...
    it("should throw error if delete fails", async () => {
      ...
      await expect(fileRepository.deleteFiles("file-123")).rejects.toThrow(
        "Delete failed",
      );
    });
  });
  ...
  describe("saveFile", () => {
    ...
    it("should throw error if save fails", async () => {
      ...
      await expect(fileRepository.saveFile(mockFile)).rejects.toThrow(
        "Save failed",
      );
    });
  });
  ...
  describe("getById", () => {
    ...
    it("should throw error when file is not found", async () => {
      ...
      await expect(
        fileRepository.getById("non-existent", mockUser),
    ...
    it("should throw error when file exists but belongs to different user", async () => {
      ...
      await expect(
        fileRepository.getById("file-123", differentUser),
      ).rejects.toThrow("File not found");
    });
    ...
    it("should handle empty string ID", async () => {
      ...
      await expect(fileRepository.getById("", mockUser)).rejects.toThrow(
        "File not found",
      );
    ...
    it("should handle null user gracefully", async () => {
      ...
      await expect(
        fileRepository.getById("file-123", null as any),
      ).rejects.toThrow("File not found");
