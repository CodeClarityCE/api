...
describe('AnalyzersController', () => {
    ...
    describe('getMany', () => {
        ...
        it('should propagate service errors', async () => {
            ...
            await expect(controller.getMany(mockAuthenticatedUser, orgId)).rejects.toThrow(
                'Service error'
            );
        });
    });
    ...
    describe('getByName', () => {
        it('should get analyzer by name successfully', async () => {
            ...
            const result = await controller.getByName(mockAuthenticatedUser, orgId, analyzerName);
    ...
    describe('get', () => {
        it('should get analyzer by id successfully', async () => {
            ...
            const result = await controller.get(mockAuthenticatedUser, analyzerId, orgId);
        ...
        it('should propagate service errors', async () => {
            ...
            await expect(controller.get(mockAuthenticatedUser, analyzerId, orgId)).rejects.toThrow(
                'Service error'
            );
    ...
    describe('update', () => {
        ...
        it('should propagate service errors', async () => {
            ...
            await expect(
                controller.update(mockAnalyzerCreateBody, mockAuthenticatedUser, analyzerId, orgId)
            ).rejects.toThrow('Service error');
    ...
    describe('delete', () => {
        it('should delete analyzer successfully', async () => {
            ...
            const result = await controller.delete(mockAuthenticatedUser, analyzerId, orgId);
