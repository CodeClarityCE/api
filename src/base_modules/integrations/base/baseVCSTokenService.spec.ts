...
describe('BaseVCSTokenService', () => {
    ...
    describe('validatePermissions', () => {
        ...
        it('should handle IntegrationInvalidToken error', async () => {
            service.mockValidateTokenScopes.mockRejectedValue(new IntegrationInvalidToken());
    ...
    describe('getTokenExpiry', () => {
        it('should call fetchTokenExpiry with correct parameters', async () => {
            ...
            expect(service.mockFetchTokenExpiry).toHaveBeenCalledWith('test-token', undefined);
        ...
        it('should pass through options', async () => {
            ...
            expect(service.mockFetchTokenExpiry).toHaveBeenCalledWith('test-token', options);
        });

        it('should handle IntegrationInvalidToken error', async () => {
            service.mockFetchTokenExpiry.mockRejectedValue(new IntegrationInvalidToken());
        ...
        it('should handle IntegrationTokenExpired error', async () => {
            service.mockFetchTokenExpiry.mockRejectedValue(new IntegrationTokenExpired());
    ...
    describe('handleTokenError', () => {
        ...
        it('should re-throw IntegrationTokenExpired', () => {
            ...
            expect(() => service['handleTokenError'](error)).toThrow(IntegrationTokenExpired);
        });

        it('should re-throw IntegrationInvalidToken', () => {
            const error = new IntegrationInvalidToken();

            expect(() => service['handleTokenError'](error)).toThrow(IntegrationInvalidToken);
        });
