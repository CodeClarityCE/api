...
describe("PackageRepository", () => {
  ...
  describe("getPackageInfo", () => {
    ...
    it("should throw EntityNotFound when package is not found", async () => {
      ...
      await expect(
        packageRepository.getPackageInfo("nonexistent-package"),
    ...
    it("should handle empty string package name", async () => {
      ...
      await expect(packageRepository.getPackageInfo("")).rejects.toThrow(
        EntityNotFound,
      );
      expect(mockRepository.findOne).toHaveBeenCalledWith({
    ...
    it("should handle special characters in package name", async () => {
      ...
      await expect(
        packageRepository.getPackageInfo(specialPackageName),
      ).rejects.toThrow(EntityNotFound);
      expect(mockRepository.findOne).toHaveBeenCalledWith({
  ...
  describe("getPackageInfoWithoutFailing", () => {
    it("should return package when found", async () => {
      ...
      const result =
        await packageRepository.getPackageInfoWithoutFailing("express");
    ...
    it("should return null when package is not found", async () => {
      ...
      const result = await packageRepository.getPackageInfoWithoutFailing(
        "nonexistent-package",
      );
    ...
    it("should handle repository errors", async () => {
      ...
      await expect(
        packageRepository.getPackageInfoWithoutFailing("express"),
    ...
    it("should handle dependency names with slashes", async () => {
      ...
      const result =
        await packageRepository.getPackageInfoWithoutFailing("org/package");
    ...
    it("should handle very long package names", async () => {
      ...
      const result =
        await packageRepository.getPackageInfoWithoutFailing(longPackageName);
  ...
  describe("getVersionInfo", () => {
    it("should return package with specific version when found", async () => {
      ...
      const result = await packageRepository.getVersionInfo(
        "express",
        "4.18.2",
      );
    ...
    it("should handle repository errors gracefully", async () => {
      ...
      await expect(
        packageRepository.getVersionInfo("express", "4.18.2"),
      ).rejects.toThrow("Database connection failed");
      expect(mockRepository.createQueryBuilder).toHaveBeenCalledWith("package");
    });
    ...
    it("should handle empty string package name and version", async () => {
      ...
      await expect(packageRepository.getVersionInfo("", "")).rejects.toThrow(
        EntityNotFound,
      );
      expect(mockRepository.createQueryBuilder).toHaveBeenCalledWith("package");
    });
  ...
  describe("Edge cases and error handling", () => {
    it("should handle undefined parameters gracefully", async () => {
      await expect(
        packageRepository.getPackageInfo(undefined as any),
      ).rejects.toThrow("Cannot read properties of undefined");
      await expect(
    ...
    it("should handle null parameters gracefully", async () => {
      await expect(
        packageRepository.getPackageInfo(null as any),
      ).rejects.toThrow("Cannot read properties of null");
      await expect(
  ...
  describe("Concurrent operations", () => {
    ...
    it("should handle concurrent requests for different packages", async () => {
      ...
      results.forEach((result, index) => {
        ...
        expect(result.description).toBe(
          `Description for ${packageNames[index]}`,
        );
      });
      expect(mockRepository.findOne).toHaveBeenCalledTimes(5);
    });
    ...
    it("should handle mixed success and failure scenarios", async () => {
      ...
      const existingResults = await Promise.all(
        existingPackages.map((packageName) =>
          packageRepository.getPackageInfo(packageName),
        ),
      );
  ...
  describe("Service initialization", () => {
    ...
    it("should have all required methods", () => {
      ...
      expect(typeof packageRepository.getPackageInfoWithoutFailing).toBe(
        "function",
      );
