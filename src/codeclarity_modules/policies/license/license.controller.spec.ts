...
import type { Policy, PolicyFrontend } from '../policy.entity';
import { PolicyType } from '../policy.entity';
...
import type {
    ...
    LicensePolicyPatchBody} from './licensePolicy.types';
import {
    LicensePolicyType
...
describe('LicensePolicyController', () => {
    ...
    beforeEach(async () => {
        ...
        licensePolicyService = module.get<LicensePolicyService>(LicensePolicyService);
    ...
    describe('create', () => {
        ...
        it('should handle whitelist policy creation', async () => {
            ...
            const result = await controller.create(mockUser, 'org-123', whitelistCreateBody);
        ...
        it('should handle blacklist policy creation', async () => {
            ...
            const result = await controller.create(mockUser, 'org-123', blacklistCreateBody);
