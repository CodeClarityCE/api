...
describe("GitlabIntegrationController", () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<GitlabIntegrationController>(
  ...
  describe("getIntegration", () => {
    it("should successfully retrieve a GitLab integration", async () => {
      gitlabService.getGitlabIntegration.mockResolvedValue(
        mockGitlabIntegration,
      );
  ...
  describe("modifyGitlabLink", () => {
    ...
    it("should throw NotAuthorized when user is not authorized", async () => {
      gitlabService.modifyGitlabIntegration.mockRejectedValue(
        new NotAuthorized(),
      );
  ...
  describe("getRepositories", () => {
    ...
    it("should successfully retrieve repositories with default parameters", async () => {
      gitlabReposService.getGitlabRepositories.mockResolvedValue(
